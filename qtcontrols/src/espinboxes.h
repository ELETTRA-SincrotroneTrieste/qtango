...
class ECommonSpinBox
{
  ...
  protected:
    ...
    /* protected: can be used by ESpinBox and EDoubleSpinBox */
    ECommonSpinBoxPrivate *d_ptr;
...
/** \brief a QSpinBox that rescales its font when resized or text changes.
 *
 * Inherited by qtango TSpinBox
 */
...
/** \brief a QDoubleSpinBox that rescales its font when resized or text changes.
 *
 * Inherited by qtango TDoubleSpinBox
 */
