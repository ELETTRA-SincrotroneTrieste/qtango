...
class EPushButtonPrivate;

class EPushButton : public QPushButton, public FontScalingWidget
{
  Q_OBJECT
  Q_ENUMS(ScaleMode)
  ...
  public:
    ...
    virtual void setFontScaleMode(ScaleMode m) { d_scaleMode = (int) m; }
